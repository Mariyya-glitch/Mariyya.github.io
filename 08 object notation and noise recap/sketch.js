// object notation and noise recap
// Mariyya
// 3/2/2026
//
// Extra for Experts:
...
let ball, ball2; //objects can not be created before setup
...
function setup() {
  ...
  ball = { // object notation. Inside the brackets
    ...
    timeX: random(11),   timeY: random(100),   timeOff: 0.08
  }
  ball2 = {
    x: 150,   y: 670,   size:40,
    c: color(random(255),random(255),random(255)),
    timeX: random(11),   timeY: random(100),   timeOff: 0.2
  }
}
...
function moveBall(b){
  ...
  //advance out noise grapgh "curoers"
